...
using MudTemplate.Server.Api.Models.Emailing;
using MudTemplate.Server.Api.Resources;
using MudTemplate.Server.Api.Services.Contracts;
using MudTemplate.Shared.Dtos.Account;

namespace MudTemplate.Server.Api.Controllers;
...
public partial class AuthController : AppControllerBase
{
    ...
    private async Task SendConfirmationEmail(SendConfirmationEmailRequestDto sendConfirmationEmailRequest, User user, CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("MudTemplate.Server.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("MudTemplate.Server.Api.Resources.ResetPassword.cshtml",
