...
namespace MudTemplate.Client.Web;
...
public class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("MudTemplate.Client.Shared.wwwroot.appsettings.json"));
